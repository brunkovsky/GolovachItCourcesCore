...
public class MainIterators {
    ...
    public static void main(String[] args) {
        ...
        MyArrays.fillRandom(matrix1, 10);
        MyArrays.fillRandom(matrix2, 10);

        System.out.println("First matrix: " + Arrays.deepToString(matrix1));
        System.out.println("Second matrix: " + Arrays.deepToString(matrix2));

        int[][] result = MyArrays.multiply(matrix1, matrix2);
        System.out.println("Result matrix: " + Arrays.deepToString(result));
    }
}
